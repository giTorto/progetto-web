    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<ul class=\"list-group\">\n"
                    ...
                    + "  <li align=\"center\" class=\"list-group-item\" onmouseover=\"document.body.style.cursor=&#39;pointer&#39;\" onmouseout=\"document.body.style.cursor=&#39;auto&#39;\" style=\"background-color:yellow\"  onclick=\"location.href='" + request.getContextPath() + "/logg/logoutSrvlt" + "'\"><h3>Logout</h3></li>\n"
                    + "</ul>");
            out.println("  </div>");
            out.println("</div>");
            out.println("");
